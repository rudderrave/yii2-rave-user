...
use ravesoft\user\models\search\PermissionSearch;
use Yii;
...
class PermissionController extends BaseController
{
     ...
     * @var Permission
     */
    public $modelClass = 'ravesoft\models\Permission';

    /**
     * @var PermissionSearch
     */
    public $modelSearchClass = 'ravesoft\user\models\search\PermissionSearch';
